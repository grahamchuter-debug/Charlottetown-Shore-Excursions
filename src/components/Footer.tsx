    ...
    <footer className="mt-auto border-t border-slate-200 bg-slate-900 text-slate-300">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-12 md:grid-cols-3">
        <div>
          ...
          <p className="mt-3 text-sm leading-relaxed">
            ...
            {GEO_LABEL} — Anne of Green Gables, red sandstone cliffs, lighthouses,
            Cavendish beaches, Confederation history, and Canada &amp; New England
            port planning.
          </p>
          <Link
            href="/enquire"
      ...
      <div className="border-t border-slate-800">
        <div className="mx-auto flex max-w-6xl flex-col gap-2 px-4 py-6 text-xs text-slate-500 sm:flex-row sm:justify-between">
          ...
          <p>
            charlottetownshoreexcursions.com · Charlottetown Harbour · Prince
