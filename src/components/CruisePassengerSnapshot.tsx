...
const defaultFields: Required<CruiseSnapshotFields> = {
  timeInPort: "6–9 hours typical Charlottetown call",
  bestFor: "Anne of Green Gables, lighthouses, downtown, beaches",
  ...
  popularTypes: "Heritage tours, coastal drives, walking tours",
};
...
export function CruisePassengerCallout({
  ...
  return (
    <section className="rounded-xl border border-blue-200 bg-blue-50 p-6">
      <h2 className="text-lg font-semibold text-blue-950">
        Best for cruise passengers in Charlottetown, Prince Edward Island
      </h2>
      <div className="mt-3 text-slate-700 leading-relaxed">
        {children ?? (
          <p>
            Charlottetown combines a compact historic capital with easy access to
            Green Gables, red cliffs, and lighthouse coasts — but rural tours need
            honest driving-time planning. Match your excursion to your berth,
            hours ashore, and all-aboard deadline.
          </p>
        )}
      </div>
    </section>
