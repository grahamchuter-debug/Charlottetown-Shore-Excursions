  ...
  return (
    <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <p className="mt-3 text-slate-700 leading-relaxed">
        {note ??
          "Build at least 45–60 minutes between your excursion's stated return and your ship's all-aboard time. Harbour traffic, rural PEI roads, and summer congestion can add unexpected delay."}
      </p>
