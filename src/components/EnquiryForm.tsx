...
function buildMailto(fields: {
  ...
  const subject = `Charlottetown shore excursion enquiry${
    ...
    <div className="space-y-6">
      <div className="rounded-xl border border-blue-200 bg-blue-50 p-5">
        ...
        <p className="mt-1 text-sm text-blue-900/80">
          Email us to ask about Charlottetown port-day options — Anne of Green
          Gables, Cavendish, walking tours, and PEI scenic loops. This site does
          not take online bookings or confirmations.
        </p>
        <a
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          ...
          <label className="block">
            <span className="text-sm font-medium text-slate-700">
              Port date in Charlottetown, PEI
            </span>
            <input
              type="date"
              name="portDate"
        ...
        <label className="block">
          ...
          <textarea
            ...
            rows={4}
            className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2"
            placeholder="Group size, mobility needs, all-aboard time, interests (Anne of Green Gables, Cavendish, lighthouses, lobster)…"
          />
        </label>
        <button
          type="submit"
