    ...
    return (
      <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-8 text-center">
        ...
        <p className="mt-2 text-emerald-800">
          Thank you — we&apos;ll respond with Charlottetown, Prince Edward
          Island excursion options matched to your ship schedule. Connect your
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <label className="block">
          <span className="text-sm font-medium text-slate-700">Port date in Charlottetown, PEI</span>
          <input
            type="date"
            name="portDate"
            className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2"
      ...
      <label className="block">
        ...
        <textarea
          ...
          rows={4}
          className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2"
          placeholder="Group size, mobility needs, all-aboard time, interests (Anne of Green Gables, lighthouses, lobster)…"
        />
      </label>
      <button
        type="submit"
